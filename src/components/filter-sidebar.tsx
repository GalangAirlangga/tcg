...
export default function FilterSidebar({ onFilterChange }: FilterSidebarProps) {
    ...
    return (
        <aside className="w-full h-fit md:w-64 bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">Filters</h2>
            <Accordion type="multiple" className="w-full">
                <AccordionItem value="supertypes">
                    <AccordionTrigger>Supertypes</AccordionTrigger>
                    <AccordionContent>
                        <ScrollArea>
                ...
                <AccordionItem value="pokemon-type">
                    <AccordionTrigger>Pokemon Type</AccordionTrigger>
                    <AccordionContent>
                        <ScrollArea>
                            <div className="space-y-2">
                                {types.map((type) => (
                ...
                <AccordionItem value="subtypes">
                    <AccordionTrigger>Subtypes</AccordionTrigger>
                    <AccordionContent>
                        <ScrollArea>
                            <div className="space-y-2">
